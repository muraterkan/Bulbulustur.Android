    ...
    Scaffold(
        ...
        topBar = {
            BbInnerPageHeader(
                ...
                actionContentDescription = "Banka HesabÄ± Ekle",
    ...
    Box(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "Geri Ã–deme Ä°Ã§in DoÄŸru IBAN Bilgisi KullanÄ±lÄ±r.",
                    style = MaterialTheme.typography.labelLarge,
                    color = BbColors.Orange.Orange700
                )

                Text(
                    text = "SipariÅŸ iptali veya Ã¼rÃ¼n iadesi nedeniyle yapÄ±lacak geri Ã¶demelerde kayÄ±tlÄ± banka hesaplarÄ±nÄ±zdan uygun olan IBAN kullanÄ±labilir.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
...
private fun BankAccountEmptyState(
    ...
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "HenÃ¼z kayÄ±tlÄ± banka hesabÄ±nÄ±z bulunmuyor. Geri Ã¶deme sÃ¼reÃ§leri iÃ§in IBAN ekleyebilirsiniz.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )

            BbButton(
                text = "Banka HesabÄ± Ekle",
