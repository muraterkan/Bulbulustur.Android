    ...
    BbCard(
        ...
        Column(
            ...
            Column(
                ...
                BbButton(
                    text = "MaÄŸaza Profilini GÃ¶rÃ¼ntÃ¼le",
                    onClick = {
...
private fun FollowedStoreEmptyState() {
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "HenÃ¼z takip ettiÄŸiniz maÄŸaza bulunmuyor. MaÄŸaza profillerini takip ederek burada hÄ±zlÄ± eriÅŸim listesi oluÅŸturabilirsiniz.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
...
private fun getDemoFollowedStores(): List<FollowedStoreUiModel> {
    return listOf(
        FollowedStoreUiModel(
            ...
            description = "Takip ettiÄŸiniz maÄŸaza",
            logoText = "B&Q",
