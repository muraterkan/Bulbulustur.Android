    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Ä°ade Edilen ÃœrÃ¼nÃ¼n FotoÄŸraflarÄ±",
                    style = BbTypography.labelSmall,
                    color = BbColors.TextMuted
                )
            }
...
private fun RequestEmptyState(
    ...
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "HenÃ¼z oluÅŸturulmuÅŸ iade veya sipariÅŸ talebiniz bulunmuyor. SipariÅŸ detayÄ±ndan yeni talep oluÅŸturabilirsiniz.",
                style = BbTypography.bodySmall,
                color = BbColors.TextMuted
            )
...
private fun getDemoRequests(): List<RequestUiModel> {
    return listOf(
        ...
        RequestUiModel(
            requestId = 2,
            requestNumber = "#2",
            createdDate = "14 MayÄ±s 2026",
            sellerName = "Ortobella Comfort",
            reason = "YanlÄ±ÅŸ ÃœrÃ¼n GÃ¶nderildi",
            productName = "Ortobella Comfort Hakiki Deri Terlik M13",
            description = "SipariÅŸ ettiÄŸim varyanttan farklÄ± bir Ã¼rÃ¼n teslim edildi. DeÄŸiÅŸim sÃ¼recini baÅŸlatmak istiyorum.",
            photoCount = 2,
...
private enum class RequestStatus(
    ...
    DamagedProduct(
        title = "ÃœrÃ¼n Defolu/HasarlÄ± Geldi"
    ),
    WaitingReview(
        title = "Ä°ncelemede"
    ),
