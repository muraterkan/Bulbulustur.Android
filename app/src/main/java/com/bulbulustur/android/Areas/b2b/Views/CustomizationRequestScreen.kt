...
fun CustomizationRequestScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationRequestHeader(
                    productName = productName
                )
            }

            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationProductSummaryCard(
                    productName = productName,
            ...
            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationLongTextField(
                    value = detail.value,
                    onValueChange = {
                        detail.value = it
                    },
            ...
            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationSuggestionChips(
                    onSuggestionClick = {
                        detail.value = it
                    }
                )
            ...
            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationTextField(
            ...
            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationHintCard()
            }

            item {
                _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationSendCard(
...
private fun CustomizationSuggestionChips(
    ...
    FlowRow(
        ...
        _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.customizationSuggestionTexts()
            .forEach { suggestion ->
            BbChip(
...
private fun customizationSuggestionTexts(): List<CustomizationSuggestionText> {
    return listOf(
        _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationSuggestionText(
            title = "Renk / Malzeme",
...
private fun CustomizationRequestScreenPreview() {
    BbTheme {
        _root_ide_package_.com.bulbulustur.android.Areas.b2b.Views.CustomizationRequestScreen()
    }
}