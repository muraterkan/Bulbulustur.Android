    ...
    BbCard(
        ...
        Column(
            ...
            Column(
                ...
                CouponInfoBox(
                    title = "KullanÄ±m tarihi / sipariÅŸ no",
...
private fun CouponEmptyState() {
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "Kupon bulunamadÄ±",
                style = MaterialTheme.typography.titleMedium,
                color = MaterialTheme.colorScheme.onSurface
            )

            Text(
                text = "HesabÄ±nÄ±za tanÄ±mlÄ± kupon oluÅŸtuÄŸunda burada listelenecek.",
...
private enum class CouponStatus(
    ...
    Used(
        title = "KullanÄ±lmÄ±ÅŸ"
    ),
    Expired(
        title = "SÃ¼resi DolmuÅŸ"
    )
}
