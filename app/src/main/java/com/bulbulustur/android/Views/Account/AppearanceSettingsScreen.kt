...
fun AppearanceSettingsScreen(
    ...
    val themes = listOf(
        AppearanceThemeOption(
            code = "light",
            title = "AÃ§Ä±k Tema",
            description = "AydÄ±nlÄ±k ve temiz gÃ¶rÃ¼nÃ¼m.",
            icon = Icons.Outlined.LightMode
        ),
        AppearanceThemeOption(
            code = "navy",
            title = "Lacivert Tema",
            description = "YumuÅŸak koyu gÃ¶rÃ¼nÃ¼m.",
            icon = Icons.Outlined.NightsStay
        ),
        AppearanceThemeOption(
            code = "dark",
            title = "Koyu Tema",
            description = "Daha kontrastlÄ± gece gÃ¶rÃ¼nÃ¼mÃ¼.",
...
private fun AppearanceIntroCard() {
    BbCard(
        ...
        Text(
            text = "Bulbulustur uygulamasÄ±nda kullanmak istediÄŸiniz gÃ¶rÃ¼nÃ¼m modunu seÃ§in.",
