        ...
        LazyColumn(
            ...
            item {
                AccountSecuritySection(
                    title = "Profil",
                    description = "HesabÄ±nÄ±zda gÃ¶rÃ¼nen temel bilgileri yÃ¶netin.",
            ...
            item {
                AccountSecuritySection(
                    title = "GiriÅŸ Ve GÃ¼venlik",
                    description = "E-posta, ÅŸifre ve giriÅŸ gÃ¼venliÄŸi ayarlarÄ±.",
                    ...
                    AccountSecurityRow(
                        title = "Åifre",
                        value = "HesabÄ±nÄ±za giriÅŸ yapmak iÃ§in kullanÄ±lÄ±r",
                    ...
                    AccountSecurityRow(
                        title = "TelefonlarÄ±m",
                        value = "SMS doÄŸrulama ve gÃ¼venlik iÅŸlemleri",
            ...
            item {
                AccountSecuritySection(
                    ...
                    description = "HesabÄ±nÄ±za yapÄ±lan eriÅŸimleri kontrol edin.",
                    icon = Icons.Outlined.History
                ) {
                    AccountSecurityRow(
                        title = "GiriÅŸ Etkinlikleri",
                        value = "Oturum hareketleri ve eriÅŸim geÃ§miÅŸi",
                        icon = Icons.Outlined.History,
...
private fun AccountSecurityIntroCard() {
    BbCard(
        ...
        Text(
            text = "Profil, giriÅŸ ve doÄŸrulama bilgilerinizi gÃ¼venle yÃ¶netin.",
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = "Telefon doÄŸrulamasÄ± tamamlandÄ±ÄŸÄ±nda gÃ¼venlik seviyeniz artar.",
                        style = BbTypography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
