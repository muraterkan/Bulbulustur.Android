package com.bulbulustur.android.features.account.review
...
fun ReviewListScreen(
    ...
    AccountPageScaffold(
        ...
        kicker = "Ürün Yorumları",
        description = "Satın aldığınız ürünler için yaptığınız değerlendirmeleri buradan görüntüleyebilir ve yönetebilirsiniz.",
