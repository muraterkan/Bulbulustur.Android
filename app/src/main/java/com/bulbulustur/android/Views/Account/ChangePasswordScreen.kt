...
private fun ChangePasswordIntroCard() {
    BbCard(
        ...
        Text(
            text = "HesabÄ±nÄ±zÄ±n ÅŸifresini gÃ¼Ã§lÃ¼ ve size Ã¶zel bir ÅŸifreyle gÃ¼ncelleyin.",
...
private fun PasswordRuleBox(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "GÃ¼Ã§lÃ¼ Åifre KontrolÃ¼",
                style = MaterialTheme.typography.labelLarge,
                color = BbColors.Yellow.Yellow800
            )

            PasswordRuleRow(
                text = "Mevcut ÅŸifre girilmeli",
                valid = validation.hasOldPassword
            )

            PasswordRuleRow(
                text = "Yeni ÅŸifre en az 8 karakter olmalÄ±",
                valid = validation.hasMinimumLength
            )

            PasswordRuleRow(
                text = "Yeni ÅŸifre bÃ¼yÃ¼k harf, kÃ¼Ã§Ã¼k harf ve rakam iÃ§ermeli",
                valid = validation.hasStrongPattern
            )

            PasswordRuleRow(
                text = "Yeni ÅŸifre ve tekrar ÅŸifre aynÄ± olmalÄ±",
