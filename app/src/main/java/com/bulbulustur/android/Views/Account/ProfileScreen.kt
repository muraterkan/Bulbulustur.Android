    ...
    Scaffold(
        ...
        topBar = {
            BbInnerPageHeader(
                ...
                actionContentDescription = "Profili DÃ¼zenle",
        ...
        LazyColumn(
            ...
            item {
                ProfileInfoSection(
                    ...
                    description = "HesabÄ±nÄ±zÄ±n gÃ¶rÃ¼nen temel bilgileri.",
            ...
            item {
                ProfileInfoSection(
                    title = "DoÄŸrulama",
                    description = "GÃ¼venlik ve hesap doÄŸrulama bilgileri.",
                    ...
                    ProfileInfoRow(
                        title = "TelefonlarÄ±m",
                        value = "1 telefon kayÄ±tlÄ± Â· doÄŸrulama bekliyor",
            ...
            item {
                ProfileInfoSection(
                    title = "Bulbulustur KullanÄ±mÄ±",
                    description = "Uygulama deneyimini ÅŸekillendiren bilgiler.",
                    icon = Icons.Outlined.Tune
                ) {
                    ProfileInfoRow(
                        title = "KullanÄ±m AmacÄ±",
                        value = "Toptan ve perakende alÄ±ÅŸveriÅŸ",
                        icon = Icons.Outlined.Tune,
            ...
            item {
                ProfileInfoSection(
                    title = "Kurumsal BaÄŸlantÄ±",
                    description = "Åirket ve B2B gÃ¶rÃ¼nÃ¼rlÃ¼k baÄŸlantÄ±larÄ±nÄ±z.",
                    icon = Icons.Outlined.Business
                ) {
                    ProfileInfoRow(
                        title = "Åirket Bilgileri",
                        value = "TÃ¼rkiye Global Ticaret Limited Åirketi",
                        icon = Icons.Outlined.Business,
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = "Telefon doÄŸrulamasÄ± ve profil fotoÄŸrafÄ± ile hesabÄ±nÄ±zÄ± gÃ¼Ã§lendirebilirsiniz.",
                        style = BbTypography.bodySmall,
