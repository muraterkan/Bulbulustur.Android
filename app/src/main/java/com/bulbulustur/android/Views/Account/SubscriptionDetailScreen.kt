    ...
    Box(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "Abonelik dÃ¶nemi ve plan Ã¼cretiniz aÅŸaÄŸÄ±daki bilgilerle kayÄ±tlÄ±dÄ±r.",
    ...
    BbCard(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "AboneliÄŸinize ait temel plan, dÃ¶nem ve Ã¼cret bilgileri.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
            ...
            SubscriptionPlanRow("BaÅŸlangÄ±Ã§ Tarihi", subscription.startDate)
            SubscriptionPlanRow("BitiÅŸ Tarihi", subscription.endDate)
            SubscriptionPlanRow("Plan FiyatÄ±", subscription.priceText, valueColor = BbColors.Yellow.Yellow800)
        }
    }
}
