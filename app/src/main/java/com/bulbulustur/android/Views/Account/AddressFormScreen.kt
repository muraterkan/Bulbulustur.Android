...
fun AddressFormScreen(
    ...
    val districtState = remember {
        mutableStateOf(if (isEditMode) "ÅiÅŸli" else "")
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            AddressFormSectionCard(
                ...
                description = "Teslimat alÄ±cÄ±sÄ± iÃ§in ad, soyad ve iletiÅŸim bilgilerini girin."
            ) {
                BbAddressTextField(
            ...
            AddressFormSectionCard(
                ...
                description = "Ãœlke, ÅŸehir ve ilÃ§e bilgilerini seÃ§in."
            ) {
                BbAddressTextField(
            ...
            AddressFormSectionCard(
                title = "Adres DetayÄ±",
                description = "AÃ§Ä±k adresinizi ve bu adres iÃ§in kullanacaÄŸÄ±nÄ±z baÅŸlÄ±ÄŸÄ± yazÄ±n."
            ) {
                BbAddressTextArea(
                ...
                BbAddressTextField(
                    ...
                    label = "Bu Adrese Bir BaÅŸlÄ±k Verin",
            ...
            BbButton(
                text = if (isEditMode) "Adresi GÃ¼ncelle" else "Adresi Kaydet",
                onClick = {
                    onSaveClick(
...
private fun AddressFormIntroCard() {
    BbCard(
        ...
        Text(
            text = "SipariÅŸlerinizde kullanmak Ã¼zere teslimat adresi oluÅŸturun. TeslimatÄ±n doÄŸru ilerlemesi iÃ§in adres bilgilerini eksiksiz girin.",
    ...
    Box(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "VarsayÄ±lan Adresim Olarak Kaydet",
                    style = BbTypography.labelLarge,
                    color = BbColors.TextStrong
                )

                Text(
                    text = "SipariÅŸlerde bu adres Ã¶ncelikli olarak kullanÄ±labilir.",
                    style = BbTypography.bodySmall,
                    color = BbColors.TextMuted
                )
            }
...
private fun AddressFormInfoBox(
    ...
    val title = if (validation.canSubmit) {
        "Adres Bilgileri Uygun GÃ¶rÃ¼nÃ¼yor"
    } else {
        "Zorunlu Adres Bilgilerini TamamlayÄ±n"
    }
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Bu bilgiler sipariÅŸ teslimatÄ± ve fatura sÃ¼reÃ§lerinde kullanÄ±lacaktÄ±r.",
                style = BbTypography.bodySmall,
                color = BbColors.TextMuted
            )
        }
