...
private fun FavoriteIntroCard(
    ...
    val description = when (selectedTab) {
        FavoriteTab.Retail -> "Perakende alÄ±ÅŸveriÅŸ iÃ§in favoriye eklediÄŸiniz Ã¼rÃ¼nleri burada gÃ¶rebilir, daha sonra incelemek veya sepete eklemek iÃ§in hÄ±zlÄ±ca geri dÃ¶nebilirsiniz."
        FavoriteTab.Wholesale -> "Toptan alÄ±ÅŸveriÅŸ iÃ§in favoriye eklediÄŸiniz Ã¼rÃ¼nleri burada gÃ¶rebilir, teklif ve tedarik sÃ¼reÃ§lerine hÄ±zlÄ±ca dÃ¶nebilirsiniz."
    }
...
private fun FavoriteEmptyState(
    ...
    val title = when (tab) {
        FavoriteTab.Retail -> "HenÃ¼z perakende favoriniz yok"
        FavoriteTab.Wholesale -> "HenÃ¼z toptan favoriniz yok"
    }

    val description = when (tab) {
        FavoriteTab.Retail -> "Perakende Ã¼rÃ¼nleri favorilerinize ekleyerek daha sonra hÄ±zlÄ±ca ulaÅŸabilirsiniz."
        FavoriteTab.Wholesale -> "Toptan Ã¼rÃ¼nleri favorilerinize ekleyerek teklif ve tedarik sÃ¼reÃ§lerine hÄ±zlÄ±ca dÃ¶nebilirsiniz."
    }
...
private fun getDemoRetailFavoriteProducts(): List<FavoriteProductUiModel> {
    return listOf(
        FavoriteProductUiModel(
            ...
            priceText = "â‚º849,90",
            metaTitle = "PERAKENDE",
            metaValue = "Sepete eklenebilir Ã¼rÃ¼n",
            mode = FavoriteMode.Retail
        ),
        FavoriteProductUiModel(
            favoriteId = 2,
            productId = 102,
            productName = "KadÄ±n Siyah KÄ±ÅŸlÄ±k Bot",
            storeName = "PetPlace",
...
private fun getDemoWholesaleFavoriteProducts(): List<FavoriteProductUiModel> {
    return listOf(
        ...
        FavoriteProductUiModel(
            favoriteId = 102,
            productId = 502,
            productName = "Toptan KÄ±ÅŸlÄ±k Bot Koleksiyonu",
            storeName = "Anadolu AyakkabÄ±",
            priceText = "Teklif ile",
            metaTitle = "TOPTAN",
            metaValue = "TedarikÃ§i yanÄ±t sÃ¼resi: 24 saat",
            mode = FavoriteMode.Wholesale
        )
    )
}
