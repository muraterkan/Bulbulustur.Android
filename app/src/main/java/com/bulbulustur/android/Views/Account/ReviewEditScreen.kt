...
fun ReviewEditScreen(
    ...
    var comment by remember {
        mutableStateOf(
            "Makineyi 7 gÃ¼ndÃ¼r kullanÄ±yorum. Bu sÃ¼re iÃ§inde hem deneyim kazandÄ±m hem de internetten okuduÄŸum birÃ§ok bilgiyle karÅŸÄ±laÅŸtÄ±rdÄ±m. ÃœrÃ¼nÃ¼ almayÄ± dÃ¼ÅŸÃ¼nenler iÃ§in detaylÄ± bir deneyim paylaÅŸmak istedim."
        )
    }
...
private fun ReviewEditProductCard() {
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "Ortobella Comfort GenÃ§ Garson Bot 8028",
                style = MaterialTheme.typography.titleMedium,
                color = MaterialTheme.colorScheme.onSurface
            )

            Text(
                text = "Bu deÄŸerlendirme Ã¼rÃ¼n detayÄ±nda ve sipariÅŸ deneyimi alanlarÄ±nda gÃ¶rÃ¼nebilir.",
