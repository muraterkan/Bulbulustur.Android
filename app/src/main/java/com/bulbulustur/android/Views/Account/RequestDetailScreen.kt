    ...
    BbCard(
        ...
        Column(
            ...
            RequestDetailSectionTitle(
                ...
                subtitle = "Talebe konu Ã¼rÃ¼n ve satÄ±cÄ± bilgileri"
            )
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = "ÃœrÃ¼n TutarÄ±: ${request.productPriceText}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = "SatÄ±cÄ± maÄŸaza bilgileri",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
...
private fun RequestDetailPhotosCard(
    ...
    BbCard(
        ...
        Column(
            ...
            RequestDetailSectionTitle(
                title = "FotoÄŸraflar",
                subtitle = "Talep sÄ±rasÄ±nda eklenen Ã¼rÃ¼n fotoÄŸraflarÄ±"
            )
...
private fun RequestDetailTimelineCard(
    ...
    BbCard(
        ...
        Column(
            ...
            RequestDetailSectionTitle(
                title = "Talep SÃ¼reci",
                subtitle = "Talebinizin iÅŸlem adÄ±mlarÄ±"
            )
...
private fun RequestDetailActionsCard(
    ...
    BbCard(
        ...
        Column(
            ...
            RequestDetailSectionTitle(
                title = "Ä°ÅŸlemler",
                subtitle = "Talebe baÄŸlÄ± hÄ±zlÄ± aksiyonlar"
            )
...
private fun getDemoRequestDetail(
    ...
    return RequestDetailUiModel(
        ...
        createdDate = "10 MayÄ±s 2026",
        statusText = "Ä°ncelemede",
        statusColor = BbColors.Orange.Orange700,
        sellerName = "Base & Quality Store",
        reason = "ÃœrÃ¼n Defolu / HasarlÄ± Geldi",
        productName = "Ortobella Comfort GenÃ§ Garson Bot 8028",
        productPriceText = "1.250 Amerikan DolarÄ±",
        description = "ÃœrÃ¼nÃ¼n saÄŸ tarafÄ±nda dikiÅŸ hatasÄ± mevcut, deÄŸiÅŸim veya iade talep ediyorum.",
        photoCount = 3,
        steps = listOf(
            RequestStepUiModel(
                title = "Talep OluÅŸturuldu",
                description = "Talebiniz baÅŸarÄ±yla oluÅŸturuldu.",
            ...
            RequestStepUiModel(
                ...
                description = "Talebe ait Ã¼rÃ¼n fotoÄŸraflarÄ± kaydedildi.",
                icon = Icons.Outlined.Image,
                color = BbColors.Green.Green600,
                isCompleted = true
            ),
            RequestStepUiModel(
                title = "SatÄ±cÄ± Ä°ncelemesi",
                description = "SatÄ±cÄ±nÄ±n talebi incelemesi bekleniyor.",
