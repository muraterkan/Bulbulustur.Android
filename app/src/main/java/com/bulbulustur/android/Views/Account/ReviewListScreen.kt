...
private fun ReviewIntroCard() {
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "AlÄ±ÅŸveriÅŸ deneyimi",
                style = MaterialTheme.typography.labelSmall,
                color = BbColors.Yellow.Yellow800
            )

            Text(
                text = "ÃœrÃ¼n, maÄŸaza ve firma deÄŸerlendirmelerinizi burada gÃ¶rÃ¼ntÃ¼leyebilir, gerektiÄŸinde dÃ¼zenleyebilir veya silebilirsiniz.",
...
private fun ReviewEmptyState(
    ...
    BbCard(
        ...
        Column(
            ...
            Text(
                text = "HenÃ¼z ${selectedTab.emptyText} bulunmuyor. DeÄŸerlendirme yaptÄ±ÄŸÄ±nÄ±zda burada listelenecek.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
...
private fun getDemoProductReviews(): List<ReviewUiModel> {
    return listOf(
        ReviewUiModel(
            ...
            title = "Ortobella Comfort GenÃ§ Garson Bot 8028",
            badgeText = "ÃœRÃœN DEÄERLENDÄ°RMESÄ°",
            comment = "Makineyi 7 gÃ¼ndÃ¼r kullanÄ±yorum. Bu sÃ¼re iÃ§inde hem deneyim kazandÄ±m hem de internetten okuduÄŸum birÃ§ok bilgiyle karÅŸÄ±laÅŸtÄ±rdÄ±m. ÃœrÃ¼nÃ¼ almayÄ± dÃ¼ÅŸÃ¼nenler iÃ§in detaylÄ± bir deneyim paylaÅŸmak istedim.",
            rating = 5,
            dateText = "22 EylÃ¼l 2025 00:31 tarihinde eklendi",
...
private fun getDemoStoreReviews(): List<ReviewUiModel> {
    return listOf(
        ReviewUiModel(
            ...
            comment = "MaÄŸaza iletiÅŸimi hÄ±zlÄ±ydÄ±. SipariÅŸ sÃ¼reci ve kargo bilgilendirmesi anlaÅŸÄ±lÄ±r ÅŸekilde ilerledi.",
            rating = 5,
...
private fun getDemoCompanyReviews(): List<ReviewUiModel> {
    return listOf(
        ReviewUiModel(
            ...
            comment = "Firma bilgileri netti, Ã¼rÃ¼n aÃ§Ä±klamalarÄ± yeterliydi. Toptan iletiÅŸim tarafÄ±nda hÄ±zlÄ± dÃ¶nÃ¼ÅŸ aldÄ±m.",
            rating = 5,
...
private enum class AccountReviewTab(
    ...
    Product(
        title = "ÃœrÃ¼n",
        emptyText = "Ã¼rÃ¼n deÄŸerlendirmesi",
        icon = Icons.Outlined.Comment
    ),
    Store(
        title = "MaÄŸaza",
        emptyText = "maÄŸaza deÄŸerlendirmesi",
        icon = Icons.Outlined.Storefront
    ),
    Company(
        title = "Firma",
        emptyText = "firma deÄŸerlendirmesi",
        icon = Icons.Outlined.Domain
    )
}
...
private val ReviewUiModel.primaryActionText: String
    get() = when (type) {
        AccountReviewTab.Product -> "ÃœrÃ¼nÃ¼ GÃ¶r"
        AccountReviewTab.Store -> "MaÄŸazayÄ± GÃ¶r"
        AccountReviewTab.Company -> "FirmayÄ± GÃ¶r"
    }
