...
import com.bulbulustur.android.Application.Areas.b2c.Views.Search.RetailSearchLandingScreen
...
RetailHomeScreen(
    ...
    composable(route = RetailRoutes.SearchLanding) {
        ...
        LaunchedEffect(
            ...
            if (productState.ProductBrands.isEmpty()) {
                productController.ProductBrands()
            }
    ...
    productController.ProductBrowsingHistories(
        ...
        RetailSearchLandingScreen(
            ...
            histories = productState.ProductBrowsingHistories,
            brands = productState.ProductBrands,
            onBackClick = {
                navigator.back()
            },
            onSearchSubmit = { searchKey ->
                navigator.navController.navigate(
                    RetailRoutes.search(searchKey)
                )
            },
