...
fun ReviewListScreen() {
    Column(
        ...
        BbSectionHeader(
            ...
            subtitle = "Daha önce yaptığınız ürün, mağaza ve firma değerlendirmelerini inceleyin"
        )
        ...
        BbCard(
            ...
            Column(
                ...
                Text(
                    text = "Henüz değerlendirme bulunmuyor. Ürün, mağaza veya firma değerlendirmesi yaptığınızda burada listelenecek.",
