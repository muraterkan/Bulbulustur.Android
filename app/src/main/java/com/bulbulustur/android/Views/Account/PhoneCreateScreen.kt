            ...
            BbCard(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Cep telefonu numaranÄ±zÄ± Ã¼lke kodu ile birlikte girebilirsiniz.",
...
private fun PhoneCreateIntroCard() {
    BbCard(
        ...
        Text(
            text = "HesabÄ±nÄ±za yeni bir cep telefonu numarasÄ± ekleyin. Numara doÄŸrulama adÄ±mÄ±ndan sonra hesabÄ±nÄ±za baÄŸlanÄ±r.",
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant
        )
    }
