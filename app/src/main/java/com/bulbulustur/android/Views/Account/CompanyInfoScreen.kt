    ...
    Scaffold(
        ...
        topBar = {
            BbInnerPageHeader(
                ...
                actionContentDescription = "Firma Bilgilerini DÃ¼zenle",
        ...
        LazyColumn(
            ...
            item {
                CompanyInfoSection(
                    title = "Åirket KimliÄŸi",
                    description = "Ãœnvan, ÅŸirket tipi ve kurumsal profil bilgileri.",
                    icon = Icons.Outlined.Badge
                ) {
                    CompanyInfoRow("Åirket ÃœnvanÄ±", "TÃ¼rkiye Global Ticaret Limited Åirketi")
                    CompanyDashedDivider()
                    CompanyInfoRow("Åirket Tipi", "Limited Åirket")
                    CompanyDashedDivider()
                    CompanyInfoRow("Abonelik PlanÄ±", "B2B e-marketplace / Free")
                    CompanyDashedDivider()
                    CompanyInfoRow("KuruluÅŸ YÄ±lÄ±", "2025")
                }
            }
            ...
            item {
                CompanyInfoSection(
                    ...
                    description = "Åirketin kayÄ±tlÄ± lokasyon bilgileri.",
                    icon = Icons.Outlined.LocationOn
                ) {
                    CompanyInfoRow("Adres", "Fulya Mah., Aytekin Kotil Cad., No: 11/1")
                    CompanyDashedDivider()
                    CompanyInfoRow("Ãœlke", "TÃ¼rkiye")
                    CompanyDashedDivider()
                    CompanyInfoRow("Åehir", "Ä°stanbul")
                    CompanyDashedDivider()
                    CompanyInfoRow("Ä°lÃ§e", "ÅiÅŸli")
                    CompanyDashedDivider()
            ...
            item {
                CompanyInfoSection(
                    ...
                    description = "Fatura ve resmi kayÄ±t sÃ¼reÃ§lerinde kullanÄ±lan bilgiler.",
                    icon = Icons.Outlined.ReceiptLong
                ) {
                    CompanyInfoRow("Vergi Dairesi", "ÅiÅŸli Vergi Dairesi")
                    CompanyDashedDivider()
                    CompanyInfoRow("Vergi NumarasÄ±", "789456123")
                    CompanyDashedDivider()
...
private fun CompanyActionSection(
    ...
    CompanyInfoSection(
        title = "Kurumsal Ä°ÅŸlemler",
        description = "Åirket profilini ticaret akÄ±ÅŸlarÄ±na baÄŸla.",
        icon = Icons.Outlined.Business
    ) {
        CompanyActionRow(
            title = "Åirketimi B2B Indexâ€™e Dahil Et",
            description = "TedarikÃ§iler ve toptan alÄ±cÄ±lar tarafÄ±ndan keÅŸfedil.",
            icon = Icons.Outlined.Storefront,
        ...
        CompanyActionRow(
            title = "B2C MaÄŸazamÄ± YÃ¶net",
            description = "Perakende maÄŸaza gÃ¶rÃ¼nÃ¼rlÃ¼ÄŸÃ¼nÃ¼ ve satÄ±ÅŸ akÄ±ÅŸÄ±nÄ± yÃ¶net.",
            icon = Icons.Outlined.HomeWork,
