        ...
        LazyColumn(
            ...
            item {
                Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(BBSpacing.Space1)) {
                    Text(text = groupName, style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.onSurface)
...
@Composable
private fun CategoryContentPagination(currentPage: Int, totalPages: Int, isLoading: Boolean, onPageChange: (Int) -> Unit) {
...
private fun ProductCategoryContentDTO.ToCardModel(isFavorite: Boolean): BbProductCardModel {
