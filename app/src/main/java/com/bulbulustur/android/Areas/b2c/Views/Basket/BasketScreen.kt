package com.bulbulustur.android.Areas.b2c.Views.Basket
...
fun BasketScreen(
    onBackClick: () -> Unit = {},
    onCheckoutClick: (List<com.bulbulustur.android.Areas.b2c.Views.Basket.BasketLineItem>) -> Unit = {},
    onProductClick: (com.bulbulustur.android.Areas.b2c.Views.Basket.BasketLineItem) -> Unit = {},
    onStoreClick: (com.bulbulustur.android.Areas.b2c.Views.Basket.BasketStoreGroup) -> Unit = {},
    onHomeClick: () -> Unit = {},
    onMenuClick: () -> Unit = {},
    ...
    val basketLines = remember {
        mutableStateListOf<com.bulbulustur.android.Areas.b2c.Views.Basket.BasketLineItem>().apply {
            addAll(_root_ide_package_.com.bulbulustur.android.Areas.b2c.Views.Basket.getBasketLineItems())
        }
    }
    ...
    val storeGroups = basketLines
        .groupBy { it.storeId }
        .map { basketGroup ->
            _root_ide_package_.com.bulbulustur.android.Areas.b2c.Views.Basket.BasketStoreGroup(
    ...
    if (showCouponSheet) {
        _root_ide_package_.com.bulbulustur.android.Areas.b2c.Views.Basket.BasketCouponSheet(
    ...
    if (showFavoriteSheet) {
        _root_ide_package_.com.bulbulustur.android.Areas.b2c.Views.Basket.BasketFavoriteSheet(
            onAddFavoriteClick = {
