    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            items(
                ...
                AddressCard(
                    address = address,
                    isSelected = selectedAddressId == address.MemberAddressId,
...
,
                        onClick = {
                            onSelectAddressClick(address.MemberAddressId)
                        },
                        modifier = Modifier.weight(1f),
