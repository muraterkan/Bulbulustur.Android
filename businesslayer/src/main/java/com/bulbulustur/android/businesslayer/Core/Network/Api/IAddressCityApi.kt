package com.bulbulustur.android.businesslayer.Core.Network.Api
...
interface IAddressCityApi {

    @GET("api/AddressCity/GetAddressCityListAsync")
    suspend fun GetAddressCityListAsync(): Result<List<AddressCityDTO>>

    @GET("api/AddressCity/GetAddressCityByIdAsync")
    suspend fun GetAddressCityByIdAsync(
        @Query("addressCityId") addressCityId: Int
    ...
    suspend fun InsertAsync(
        @Body model: AddressCityInsertModel
    ): Result<Unit>

    @POST("api/AddressCity/UpdateAsync")
    suspend fun UpdateAsync(
        @Body model: AddressCityUpdateModel
    ): Result<Unit>
