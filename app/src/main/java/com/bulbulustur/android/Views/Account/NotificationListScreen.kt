...
private fun NotificationIntroCard() {
    BbCard(
        ...
        Row(
            ...
            Text(
                text = "SipariÅŸ, teklif, kargo ve hesap bildirimlerini buradan takip edebilirsin.",
...
private fun getDemoNotifications(): List<NotificationItem> {
    return listOf(
        NotificationItem(
            ...
            description = "BB-2026-0001 numaralÄ± sipariÅŸiniz satÄ±cÄ± tarafÄ±ndan hazÄ±rlanÄ±yor.",
            timeText = "BugÃ¼n",
            icon = Icons.Outlined.ShoppingBag,
            isUnread = true
        ),
        NotificationItem(
            title = "Yeni RFQ CevabÄ± Geldi",
            description = "Toptan fiyat teklifi talebiniz iÃ§in yeni bir satÄ±cÄ± cevabÄ± var.",
            timeText = "DÃ¼n",
        ...
        NotificationItem(
            ...
            description = "SipariÅŸiniz kargo hazÄ±rlÄ±k aÅŸamasÄ±na geÃ§ti.",
            timeText = "2 gÃ¼n Ã¶nce",
            icon = Icons.Outlined.LocalShipping,
            isUnread = false
        ),
        NotificationItem(
            title = "GÃ¼venlik Ã–nerisi",
            description = "Telefon doÄŸrulamasÄ±nÄ± tamamlayarak hesabÄ±nÄ±zÄ± daha gÃ¼venli hale getirebilirsiniz.",
            timeText = "Bu hafta",
