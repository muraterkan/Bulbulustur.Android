    ...
    Box(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "Ä°ade bakiyesi, bekleyen Ã¶deme hareketleri ve finansal iÅŸlemler burada gÃ¶rÃ¼ntÃ¼lenir.",
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = "Bakiye, iade ve Ã¶deme hareketleriniz oluÅŸtuÄŸunda burada listelenir.",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            ...
            Box(
                ...
                Text(
                    text = "HenÃ¼z finansal hareket bulunmuyor.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = "BaÄŸlÄ± Banka HesaplarÄ±",
                        style = MaterialTheme.typography.titleMedium,
                        color = MaterialTheme.colorScheme.onSurface
                    )

                    Text(
                        text = "Ä°ade ve geri Ã¶deme sÃ¼reÃ§lerinde kullanÄ±lacak IBAN bilgilerinizi yÃ¶netin.",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            ...
            BbButton(
                text = "Banka HesaplarÄ±nÄ± YÃ¶net",
