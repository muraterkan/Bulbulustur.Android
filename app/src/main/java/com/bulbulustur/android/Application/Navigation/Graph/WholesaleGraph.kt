...
fun NavGraphBuilder.wholesaleGraph(
    ...
    composable(
        ...
        val categoryIds = androidx.compose.runtime.remember(productCategoryId, categoryState.Categories) {
            categoryController.GetCategoryScopeIds(productCategoryId)
        }

        LaunchedEffect(sessionState.Language.Id, productCategoryId, categoryIds) {
