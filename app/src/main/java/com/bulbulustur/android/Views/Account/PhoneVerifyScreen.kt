            ...
            BbCard(
                ...
                Column(
                    ...
                    Column(
                        ...
                        Text(
                            text = "$phone numarasÄ±na gÃ¶nderilen kodu girin.",
...
private fun PhoneVerifyIntroCard(
    ...
    BbCard(
        ...
        Text(
            text = "Telefon numaranÄ±za gÃ¶nderilen doÄŸrulama kodunu girerek $phone numarasÄ±nÄ± hesabÄ±nÄ±za doÄŸrulanmÄ±ÅŸ olarak baÄŸlayabilirsiniz.",
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant
        )
    }
