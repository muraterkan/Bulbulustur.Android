...
fun FirstDoorScreen(
    ...
    LogonPublicScaffold(
        ...
        LogonPublicPageTitle(
            eyebrow =
                BBLocalization.Current.Get(key = "67f4719d-9886-4fbc-9fad-0ef6a100db26", fallback = "Yeni Üyelik"),
            title =
                BBLocalization.Current.Get(key = "e6f44bb3-1a51-4db7-86d7-ab38d008440a", fallback = "E-posta Adresinizi Girin"),
            description =
                BBLocalization.Current.Get(key = "ff3bf20d-7ddc-4034-a9d5-000c7ea4a69c", fallback = "Kayıt işlemini başlatmak için e-posta adresinize bir doğrulama bağlantısı göndereceğiz.")
        )
        ...
        if (isLoading) {
            ...
            Row(
                ...
                Text(
                    text =
                        BBLocalization.Current.Get(key = "0b721994-9d50-4a43-8fcf-82c33dfde21e", fallback = "Doğrulama e-postası hazırlanıyor."),
                    style = MaterialTheme.typography.bodySmall,
