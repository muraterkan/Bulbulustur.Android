...
private fun ChangeEmailIntroCard() {
    BbCard(
        ...
        Text(
            text = "HesabÄ±nÄ±za baÄŸlÄ± e-posta adresini gÃ¼ncelleyin. Yeni e-posta iÃ§in doÄŸrulama sÃ¼reci gerekebilir.",
...
private fun EmailSupportingText(
    ...
    if (newEmail.isBlank()) {
        Text(
            text = "Yeni e-posta adresinizi yazÄ±n.",
            color = MaterialTheme.colorScheme.onSurfaceVariant
        )
    ...
    if (validation.isSameEmail) {
        Text(
            text = "Yeni e-posta mevcut e-posta ile aynÄ± olamaz.",
            color = MaterialTheme.colorScheme.error
        )
    ...
    Text(
        text = "E-posta formatÄ± uygun gÃ¶rÃ¼nÃ¼yor.",
...
private fun ChangeEmailInfoBox() {
    Box(
        ...
        Column(
            ...
            Text(
                text = "DoÄŸrulama Gerekebilir",
                style = MaterialTheme.typography.labelLarge,
                color = BbColors.Blue.Blue700
            )

            Text(
                text = "E-posta deÄŸiÅŸikliÄŸinden sonra hesabÄ±nÄ±zÄ±n gÃ¼venliÄŸi iÃ§in yeni adresin doÄŸrulanmasÄ± istenebilir.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
